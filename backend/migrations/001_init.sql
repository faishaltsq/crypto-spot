...
CREATE TABLE IF NOT EXISTS orderbook_metrics (
    ...
    bid_depth_quote DOUBLE PRECISION NOT NULL DEFAULT 0,
    ask_depth_quote DOUBLE PRECISION NOT NULL DEFAULT 0,
    imbalance DOUBLE PRECISION NOT NULL DEFAULT 0,
    spoof_score DOUBLE PRECISION NOT NULL DEFAULT 0,
    removal_quote DOUBLE PRECISION NOT NULL DEFAULT 0,
...
CREATE INDEX IF NOT EXISTS idx_orderbook_metrics_symbol_time
    ON orderbook_metrics (symbol, recorded_at DESC);
...
CREATE TABLE IF NOT EXISTS market_features (
    ...
    spoof_score DOUBLE PRECISION NOT NULL DEFAULT 0,
    relative_volume_1m DOUBLE PRECISION NOT NULL DEFAULT 0,
    volume_delta_ratio_1m DOUBLE PRECISION NOT NULL DEFAULT 0,
    trend_alignment DOUBLE PRECISION NOT NULL DEFAULT 0,
    rule_score DOUBLE PRECISION NOT NULL DEFAULT 0,
    data_quality_score DOUBLE PRECISION NOT NULL DEFAULT 0,
    status VARCHAR(40) NOT NULL,
    trend_by_timeframe JSONB NOT NULL DEFAULT '{}'::jsonb,
...
CREATE INDEX IF NOT EXISTS idx_market_features_score_time
    ON market_features (rule_score DESC, calculated_at DESC);
...
CREATE TABLE IF NOT EXISTS signals (
    ...
    target_price_1 DOUBLE PRECISION NOT NULL,
    target_price_2 DOUBLE PRECISION NOT NULL,
